package com.example.vasux.utils;
 ...
 */
    ...
    public static boolean connectToOpenWifi(WifiManager mWifiManager, String netSSID, boolean disableOthers) {
        ...
        if (mWifiManager.isWifiEnabled()) {
            ...
            if (disableOthers) {
                ...
                enableVasuXNetwork(mWifiManager, netSSID);
            }
    ...
    public static boolean enableVasuXNetwork(WifiManager wifiManager, String ssid) {
        boolean state = false;
    ...
    public static boolean isWifiConnectedToSTAccessPoint(Context context) {
        return isConnectedOnWifi(context, true) && isVasuXSSID(((WifiManager) context.getApplicationContext().getSystemService(Context.WIFI_SERVICE)).getConnectionInfo().getSSID());
    }
    ...
    public static boolean isVasuXSSID(String ssid) {
        if (isOreoOrAbove()) {
